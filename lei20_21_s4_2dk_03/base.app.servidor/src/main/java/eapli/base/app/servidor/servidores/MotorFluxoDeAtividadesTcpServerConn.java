package eapli.base.app.servidor.servidores;
...
import eapli.base.app.servidor.escalonadores.EscalonadorSettings;
import eapli.base.app.servidor.protocol.InformacaoUtilizador;
...
public class MotorFluxoDeAtividadesTcpServerConn extends Thread implements Constantes {
    ...
    private boolean executarAtividadeAutomatica() {
        ...
        EscalonadorSettings settingEscalonamento = new EscalonadorSettings();
        EscalonadorAtividadesAutomaticasExecutor escalonador = settingEscalonamento.escalonadorTarefasInstancia();
        ...
        try {
            do {
                ...
                if (!ATREP.containsOfIdentity(input)) {
                    ...
                    escalonador.adicionarTrabalho(atividade);
                }
    ...
    private boolean tratamentoUserDashboard(int dataSize) {
        try {
