...
import eapli.base.infrastructure.bootstrapers.CatalogoServicoBootstrapper;
import eapli.base.infrastructure.bootstrapers.EstruturaBootstrapper;
import eapli.base.infrastructure.bootstrapers.NivelBootstrapper;
...
public final class BaseBootstrap extends BaseApplication {
    ...
    protected void doMain(final String[] args) {
        ...
        System.out.println("\n\n------- ESTRUTURA DATA -------");
        new EstruturaBootstrapper().execute();

        System.out.println("\n\n------- CATALOGO/SERVIÇO DATA -------");
        new CatalogoServicoBootstrapper().execute();

        System.out.println("\n\n------- NÍVEL CRITICIDADE DATA -------");
        new NivelBootstrapper().execute();
