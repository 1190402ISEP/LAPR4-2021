package eapli.base.app.motorfluxosatividades.utils;
...
public interface Constantes {
    ...
    int PORTO_SERVIDORES_EXECUTOR_TAREFAS_AUTOMATICAS = 10424;
    /*IP´S*/
    String IP_SERVIDOR_EXECUTOR_TAREFAS_AUTOMATICAS = "10.9.21.168";
    ...
    String MOTOR_FLUXOS_ATIVIDADES_TRUSTED_STORE = "client5_J.jks";
    String EXECUTOR_KEY_PASS = "forgotten2";
}
