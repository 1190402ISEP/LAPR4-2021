...
/**
 * The type Atribuidor de tarefas inteligente.
 */
public class AtribuidorDeTarefasInteligente implements EscalonadoresAssignarTarefas {
    private final UtilAtribuicaoAtividadesManuais util;
    private AtividadeManual atManual;

    /**
     * Instantiates a new Atribuidor de tarefas inteligente.
     */
    public AtribuidorDeTarefasInteligente() {
    ...
    public void atribuirAtividadesManuaisAutomaticamente(String idEquipa) {
        Colaborador colab = util.colaboradoremMelhorSituacaoParaTerminarTarefa(idEquipa, atManual.identity());
